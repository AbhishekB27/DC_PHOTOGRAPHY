    ...
    <div className="w-full flex justify-center items-start lg:items-center py-2 min-h-[34.3rem] lg:min-h-[35.2rem] cursor-pointer">
      <div className="container flex flex-col lg:justify-center lg:flex-row gap-1">
        ...
        <div className="flex lg:relative flex-col lg:items-star lg:text-left lg:justify-center items-center lg:items-start lg:w-[50%] gap-2 lg:order-">
          <img  className="camera absolute bottom-[1rem] md:bottom-auto lg:left-[3rem] h-[16rem] w-[16rem]" src={Camera} alt="" />
          <div className="absolute w-[5.5rem] h-[5.5rem] left-[8.5rem] bottom-[8rem] md:left-[15rem] lg:left-[3rem] lg:w-[8.5rem] lg:h-[8.5rem] bg-clip-padding backdrop-filter backdrop-blur-sm bg-gray-400 border-gray-100 bg-opacity-30 rounded-2xl rotate-45"></div>
          <div className="absolute w-[5.5rem] h-[5.5rem] bottom-[1.5rem] md:right-[25rem] right-[13rem] lg:top-[-2rem] lg:left-[18rem] lg:w-[8.5rem] lg:h-[8.5rem] bg-clip-padding backdrop-filter backdrop-blur-sm bg-gray-400 border-gray-100 bg-opacity-30 rounded-2xl rotate-[-45deg]"></div>
          <div className="absolute w-[5.5rem] h-[5.5rem] right-[6rem]  bottom-[7rem] lg:bottom-[-1rem] lg:left-[20rem] lg:w-[8.5rem] lg:h-[8.5rem] bg-clip-padding backdrop-filter backdrop-blur-sm bg-gray-400 border-gray-100 bg-opacity-30 rounded-2xl rotate-[-45deg]"></div>
