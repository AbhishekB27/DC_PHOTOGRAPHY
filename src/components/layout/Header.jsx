    ...
    <header className="flex flex-col gap-1">
      <div className="flex justify-between items-center pb-1 border-b-2 border-[#e2fdff]">
        <div className="relative cursor-pointer  px-1 text-white flex justify-center items-center">
          ...
          <img
            className="w-[2rem] hover:scale-105 transition-all md:w-[3rem] h-[2rem] md:h-[3rem] "
            src={DCLOGO}
            alt=""
          />
          <div className="flex flex-col justify-center items-end ">
            <span className="text-sm md:text-lg bg-clip-text bg-transparent bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500  tracking-wider font-dancingScript lg:font-extrabold">
              DC PHOTOGRAPHY
            </span>
            <span className="text-xs md:text-sm font-ubuntu bg-clip-text bg-transparent bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500">
              Camera is our pen
            </span>
          </div>
        </div>
        ...
        >
          <Link to="/">
            <li
              ...
              className="text-lg font-ubuntu font-semibold cursor-pointer lg:bg-gradient-to-r lg:from-[#e2fdff] lg:to-[#e2fdff] lg:bg-left-bottom lg:bg-no-repeat lg:bg-[length:0%_3px] lg:hover:bg-[length:100%_3px] lg:transition-all"
            >
              HOME
            </li>
          </Link>
